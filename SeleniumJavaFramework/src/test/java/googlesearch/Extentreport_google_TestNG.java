...
public class Extentreport_google_TestNG {
	...
	public void test2() throws InterruptedException {
		...
		boolean x;
		WebElement btn = driver.findElement(By.xpath("//section[@id='user-hero']//a[@class='btn-primary'][contains(text(),'Submit a tuition request now')]"));
		x = btn.isEnabled();
